...
AGENT_PROFILES: dict[str, AgentProfile] = {
    ...
    "builder": AgentProfile(
        ...
        prompt=(
            ...
            "if tool evidence shows a verification command ran successfully. If verification fails, your final "
            "answer must start with INCOMPLETE and include the failing command, error output, and next exact fix. "
            "If verification passes, start with COMPLETE. If you only inspected files or formed "
